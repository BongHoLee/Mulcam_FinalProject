		...
		<div class="product-body">
			...
			<form class="review-form" enctype="multipart/form-data" method="POST"
				...
				<div class="form-group">
					...
					<input type='date' class='input'name="STARTINGDAY" value="${resultMap.STARTINGDAY }" data-language='en' readonly/>
				</div>
				<div class="form-group">
					<h4 class="text-uppercase">FINISHINGDAY</h4>
					<input class="input" type="date" name="FINISHINGDAY"
						value="${resultMap.FINISHINGDAY}" placeholder="Event Finish" readonly />
				</div>
				<div class="form-group">
					<h4 class="text-uppercase">TITLE</h4>
					<input class="input" type="text" name="TITLE" value="${resultMap.TITLE}"readonly />
				</div>
				<div class="form-group">
					<h4 class="text-uppercase">KEYWORD</h4>
					<input class="input" type="text" name="KEYWORD" value="${resultMap.KEYWORD}"  readonly />
				</div> 
				<!--  파일 업로드 버튼 -->
				<div class="form-group">
					<h4 class="text-uppercase">IMG NAME</h4>
					<input class="input" type="text" name="IMG" value="${resultMap.IMG}"  readonly />
					<input class="hidden" type="file" id="imgInp" name="ATTACHEDFILES01" />
				</div>
				<button type="submit" class="primary-btn">Update Button</button>
			</form>
		</div>
	</div>
